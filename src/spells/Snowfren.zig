...
pub const title = "Snowfren";

pub const enum_name = "snowfren";
...
pub fn cast(self: *const Spell, caster: *Thing, room: *Room, params: Params) Error!void {
    ...
    const snowfren = self.kind.snowfren;
    _ = snowfren;
    const target_pos = params.pos;
    const spawner = Thing.SpawnerController.prototypeSummon(.snowfren);
